...
,	_page_ptr (0)
,	_page_size ()
,	_edit_prog_sptr (  new NText (0))
,	_edit_bank_sptr (  new NText (1))
,	_edit_layout_sptr (new NText (2))
,	_edit_master_sptr (new NText (3))
,	_reboot_sptr (     new NText (4))
{
...
void	MenuMain::do_connect (Model &model, const View &view, PageMgrInterface &page, Vec2d page_size, const ui::Font &fnt_s, const ui::Font &fnt_m, const ui::Font &fnt_l)
{
	...
	PageMgrInterface::NavLocList  nav_list (5);
...
MsgHandlerInterface::EvtProp	MenuMain::do_handle_evt (const NodeEvt &evt)
{
	...
	if (evt.is_button_ex ())
	{
		...
		case Button_S:
			...
			{
/*			case 0: _page_switcher.switch_to (pg::PageType_EDIT_PROG);  break;
			case 1: _page_switcher.switch_to (pg::PageType_EDIT_BANKS); break;
			case 2: _page_switcher.switch_to (pg::PageType_PB_LAYOUT);  break;
			case 3: _page_switcher.switch_to (pg::PageType_MASTER_VOL); break;
			case 4: _page_switcher.switch_to (pg::PageType_REBOOT);     break;
*/			default:
