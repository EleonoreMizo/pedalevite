...
public:
	               ...
	               DiodeClipJcm ()                          = default;
	               DiodeClipJcm (const DiodeClipJcm &other) = default;
	               DiodeClipJcm (DiodeClipJcm &&other)      = default;

	virtual        ~DiodeClipJcm ()                         = default;

	DiodeClipJcm & operator = (const DiodeClipJcm &other)   = default;
	DiodeClipJcm & operator = (DiodeClipJcm &&other)        = default;
