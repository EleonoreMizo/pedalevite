...
template <int O>
constexpr int	SplitMultibandLin <O>::_order;
template <int O>
constexpr int	SplitMultibandLin <O>::_nbr_2p;
template <int O>
constexpr int	SplitMultibandLin <O>::_nbr_1p;
...
template <int O>
constexpr int	SplitMultibandLin <O>::_max_buf_size;
