...
void	OnePole::process_block (float dst_ptr [], const float src_ptr [], long nbr_spl)
{
	assert (dst_ptr != 0);
	assert (src_ptr != 0);
	assert (nbr_spl > 0);
...
void	OnePole::process_block (float dst_ptr [], const float src_ptr [], long nbr_spl, const float inc_b [2], const float inc_a [2])
{
	assert (dst_ptr != 0);
	assert (src_ptr != 0);
	assert (nbr_spl > 0);
