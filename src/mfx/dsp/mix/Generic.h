...
#pragma once
#if ! defined (mfx_dsp_mix_Generic_HEADER_INCLUDED)
#define mfx_dsp_mix_Generic_HEADER_INCLUDED
...
private:
	...
	void           setup_internal () noexcept;

	static void    setup_fpu () noexcept;

	static Generic &
	               use_instance () noexcept;
...
//#include "mfx/dsp/mix/Generic.hpp"



#endif   // mfx_dsp_mix_Generic_HEADER_INCLUDED
