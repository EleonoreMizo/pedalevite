...
public:
	...
	static const int  PITCH_FRAC_BITS = Oscillator::PITCH_FRAC_BITS;
	               ...
	               OscSampleSyncFade ();
	               OscSampleSyncFade (const OscSampleSyncFade &other) = default;
	virtual        ~OscSampleSyncFade ()                              = default;
	OscSampleSyncFade &
	               operator = (const OscSampleSyncFade &other)        = default;
