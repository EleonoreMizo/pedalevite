...
- VS: same as VD, but for reading only (source access)
	...
	static fstb::Vs32 VS::load_s32 (const void *ptr);
...
#pragma once
#if ! defined (mfx_dsp_shape_WsLight3_HEADER_INCLUDED)
#define mfx_dsp_shape_WsLight3_HEADER_INCLUDED
...
#include "mfx/dsp/shape/WsLight3.hpp"



#endif   // mfx_dsp_shape_WsLight3_HEADER_INCLUDED
