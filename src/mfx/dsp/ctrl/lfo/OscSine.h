...
#pragma once
#if ! defined (mfx_dsp_ctrl_lfo_OscSine_HEADER_INCLUDED)
#define mfx_dsp_ctrl_lfo_OscSine_HEADER_INCLUDED
...
public:
	               ...
	               OscSine ()                        = default;
	               OscSine (const OscSine &other)    = default;
	virtual        ~OscSine ()                       = default;
	OscSine &      operator = (const OscSine &other) = default;
...
private:
	...
	bool           operator == (const OscSine &other) const = delete;
	bool           operator != (const OscSine &other) const = delete;
...
//#include "mfx/dsp/ctrl/lfo/OscSine.hpp"



#endif   // mfx_dsp_ctrl_lfo_OscSine_HEADER_INCLUDED
