...
#pragma once
#if ! defined (mfx_pi_dly1_DelayDesc_HEADER_INCLUDED)
#define mfx_pi_dly1_DelayDesc_HEADER_INCLUDED
...
private:
	...
	void           init_level (bool dry_flag);
	void           init_time (int chn);
	void           init_fdbk (int chn);
...
//#include "mfx/pi/dly1/DelayDesc.hpp"



#endif   // mfx_pi_dly1_DelayDesc_HEADER_INCLUDED
