...
#pragma once
#if ! defined (mfx_pi_sfreeze_Cst_HEADER_INCLUDED)
#define mfx_pi_sfreeze_Cst_HEADER_INCLUDED
...
//#include "mfx/pi/sfreeze/Cst.hpp"



#endif   // mfx_pi_sfreeze_Cst_HEADER_INCLUDED
