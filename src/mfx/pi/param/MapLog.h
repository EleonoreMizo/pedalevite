...
#pragma once
#if ! defined (mfx_pi_param_MapLog_HEADER_INCLUDED)
#define mfx_pi_param_MapLog_HEADER_INCLUDED
...
#include "mfx/pi/param/MapLog.hpp"



#endif   // mfx_pi_param_MapLog_HEADER_INCLUDED
