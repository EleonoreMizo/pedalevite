...
#pragma once
#if ! defined (mfx_pi_flancho_Cst_HEADER_INCLUDED)
#define mfx_pi_flancho_Cst_HEADER_INCLUDED
...
//#include "mfx/pi/flancho/Cst.hpp"



#endif   // mfx_pi_flancho_Cst_HEADER_INCLUDED
