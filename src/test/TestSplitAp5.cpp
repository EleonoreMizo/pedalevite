...
int	TestSplitAp5::perform_test ()
{
	int            ret_val = 0;

	printf ("Testing mfx::dsp::iir::SplitAp5...\n");
	...
	{
		mfx::FileOpWav::save (
			"results/splitap5-comp_dif.wav", dst_cp, sample_freq, 0.5f
		);
		printf (
			"\n*** Error: "
	...
	mfx::FileOpWav::save ("results/splitap5-lo.wav", dst_lo, sample_freq, 0.5f);
	mfx::FileOpWav::save ("results/splitap5-hi.wav", dst_hi, sample_freq, 0.5f);
