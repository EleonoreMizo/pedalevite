...
template <int NC>
Downsampler2x8F64Avx512 <NC>::Downsampler2x8F64Avx512 ()
:	_filter ()
{
...
template <int NC>
void	Downsampler2x8F64Avx512 <NC>::set_coefs (const double coef_arr [])
{
...
template <int NC>
__m512d	Downsampler2x8F64Avx512 <NC>::process_sample (const double in_ptr [_nbr_chn * 2])
{
...
template <int NC>
__m512d	Downsampler2x8F64Avx512 <NC>::process_sample (__m512d in_0, __m512d in_1)
{
	__m512d         spl_0 = in_1;
	__m512d         spl_1 = in_0;
...
template <int NC>
void	Downsampler2x8F64Avx512 <NC>::process_block (double out_ptr [], const double in_ptr [], long nbr_spl)
{
	assert (in_ptr  != nullptr);
...
template <int NC>
void	Downsampler2x8F64Avx512 <NC>::process_sample_split (__m512d &low, __m512d &high, const double in_ptr [_nbr_chn * 2])
{
	assert (in_ptr != nullptr);
...
template <int NC>
void	Downsampler2x8F64Avx512 <NC>::process_sample_split (__m512d &low, __m512d &high, __m512d in_0, __m512d in_1)
{
	__m512d         spl_0 = in_1;
	__m512d         spl_1 = in_0;
...
template <int NC>
void	Downsampler2x8F64Avx512 <NC>::process_block_split (double out_l_ptr [], double out_h_ptr [], const double in_ptr [], long nbr_spl)
{
	assert (in_ptr    != nullptr);
...
template <int NC>
void	Downsampler2x8F64Avx512 <NC>::clear_buffers ()
{
	for (int i = 0; i < NBR_COEFS + 2; ++i)
	{
