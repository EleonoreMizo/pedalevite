...
template <class TO>
int	TestHalfBand <TO>::perform_test (TO &filter, const double coef_arr [NBR_COEFS], const SweepingSine &ss, const char *type_0, double transition_bw, double stopband_at)
{
